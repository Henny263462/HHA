...
object HhaConfig {
    ...
    val NUMBER_DEFAULTS: Map<String, Double> = linkedMapOf(
        ...
        "air_jumps" to 2.0,
        "stomp_damage" to 9.0,
        "shockwave_base_damage" to 5.0,
        "shockwave_max_damage" to 24.0,
        "beam_damage" to 12.0,
        "purify_heal" to 4.0,
        "light_wave_damage" to 5.0,
        "light_wave_knockback" to 1.8,
        "ember_damage" to 3.0,
        "pull_arrival_damage" to 10.0,
        "bounce_damage" to 4.0,
        "pull_range" to 16.0,
        "grapple_range" to 32.0,
        "hell_absorption_duration" to 2400.0,
        "divine_shield_cooldown" to 1200.0,
        "beam_cooldown" to 200.0,
